...
from .views import UpdateMyProfileView, UserAddAvatarView, UserCreateView, UserListByIdView, UserListSelfView, UserListView
...
urlpatterns = [
    ...
    path('/avatar', UserAddAvatarView.as_view(), name='add_avatar'),
